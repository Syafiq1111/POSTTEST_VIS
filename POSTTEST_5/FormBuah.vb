Public Class FormBuah
    ...
    Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
        If txtNama.Text = "" Then
            MessageBox.Show("Nama buah harus diisi!")
            Exit Sub
        End If

        If SimpanBuah(txtNama.Text, Val(txtHarga.Text), Val(txtStok.Text)) Then
    ...
    Private Sub dgvBuah_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvBuah.CellClick
        If e.RowIndex >= 0 Then
            ...
            txtNama.Text = dgvBuah.Rows(e.RowIndex).Cells(1).Value.ToString()
            txtHarga.Text = dgvBuah.Rows(e.RowIndex).Cells(2).Value.ToString()
            txtStok.Text = dgvBuah.Rows(e.RowIndex).Cells(3).Value.ToString()
        End If
    End Sub
